...
Il sistema utilizzato per gestire le tensioni PoL (\textit{Point of Load}) sfrutta un circuito innovativo, in tecnologia CMOS a 65 nm, basato su un regolatore con caratteristiche di LDO (\textit{Low Drop Out}) accoppiato ad uno Shunt, o ShuntLDO. 
