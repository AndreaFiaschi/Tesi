...
% alimentando i moduli in serie di ${\cal O}(10)$.
...
%Il ROC stesso necessita di due linee di alimentazione separate e sul singolo modulo a pixel vi saranno più ROC alimentati in parallelo.
...
%, per verificare l'effettiva capacità dello ShuntLDO di isolare il ROC rispetto alla linea di alimentazione. 
