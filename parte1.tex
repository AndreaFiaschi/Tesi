...
\centering
%\subfloat[][Fondo $WW$.]
\includegraphics[width=.75\textwidth]{Immagini/SLDO5Serie1}
%\subfloat[][Fondo $WW$.]
\includegraphics[width=.75\textwidth]{Immagini/SLDO5Serie2}
...
La pendenza delle due curve riportate è la stessa e ci fornisce un'indicazione del valore resistivo, R, dei \textit{wire bond}, mentre l'offset cambia, nel modo in cui ci si aspetterebbe da uno spostamento di tensione dato dalla corrente che scorre verso il GND del chip: maggiore è la corrente richiesta dal carico, minore è l'offset.
...
Il valore della resistenza equivalente è molto piccolo e, come detto, dipende in prima approssimazione dal numero di wire bond.
