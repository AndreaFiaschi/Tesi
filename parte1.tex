...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.4\textwidth]{Immagini/CaratteristicaSLDO.png}
\caption{Curva caratteristica corrente-tensione per uno ShuntLDO che mostra $\mathrm{V_{in}}$ () e $\mathrm{V_{out}}$ () in funzione di $\mathrm{I_{in}}$; la 
Circuito semplificato dello SLDO 0.5 A.}
\label{SLDO5A}
\end{figure}
