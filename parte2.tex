...
Inoltre, in RD53A, la matrice di pixel ha 400 colonne e 192 righe, in realtà il sistema di alimentazione e di polarizzazione dei pixel è progettato per un numero di righe massimo pari a 384.%dal manuale
...
Al di sopra di questa è presente una fila di piazzole utilizzate per misure di \textit{debug}, che sarà eliminata nella versione finale.
La parte di circuito necessaria per configurare, monitorare e leggere il chip, invece, si trova nella parte in basso con posta al di sotto solo una fila di piazzole per i \textit{wire-bond}. 
...
La parte più bassa, sopra le piazzole per i wire-bond, ospita gli ShuntLDO che sono distribuiti su 
