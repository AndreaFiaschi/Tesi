...
\toprule
\midrule
\mathrm{Tecnologia} & \quad 65 \mathrm{nm \quad CMOS}\\
\mathrm{Dimensione del ROC} & \quad \mathrm{22\mm \times (16.4\mm + 2\mm)} \\
\mathrm{Dimensione del pixel} & \quad \mathrm{50 \times 50 \mu m^2, 25 \times 100 \mu m^2} \\
\mathrm{Dimensione della cella} & \quad \mathrm{2500\um^2} \\
\mathrm{Numero dei pixel} & \quad \mathrm{144320} \\
\mathrm{Hit rate} & \quad \mathrm{< 3 GHz/cm^2} \\
\mathrm{Risoluzione in carica} & \quad \mathrm{4 bit - Time-over-Threshold (ToT)} \\
\mathrm{Soglia} & \quad \mathrm{<600e^- min (<1200e^- nel BX corretto)}\\
\mathrm{Frazione hit da rumore} & \quad \mathrm{<10^{-6}}\\
\bottomrule
\end{array}
\]
